...
function BrouseModel() {
  return (
    <div className="min-h-1/3 bg-gray-900 flex items-center justify-center p-6 containers">
      <Link to="/models" className="text-3xl">
        {" "}
